...
class InstallService
{
    ...
    public static function createProfile(array $input) {
        ...
        $config = [
            ...
            "meta_description" => "$platformName: Crypto and stocks investment",
            "meta_keywords" => "$platformName, Investment, Finance, Wealth, Stocks",
            "logo" => "app/assets/images/logo/logo-icon.png",
            "email" => "$supportMail",
            "address" => "$address"
        ];
