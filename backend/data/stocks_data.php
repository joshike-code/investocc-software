...
return [
    [
        ...
        'categories' => json_encode(['featured', 'moneystart', 'magnificient-7', 'warren-buffet', 'technology', 'most-popular', 'all-stocks', 'ross-gerber', 'most-bought', 'biggest-companies', 'investing-starterpack', 'self-driving', 'dividend-stocks', 'ken-griffin'])
    ],
    [
        'name' => 'Amazon.com Inc.',
        'trade_name' => 'AMZN',
        ...
        'categories' => json_encode(['featured', 'moneystart', 'magnificient-7', 'technology', 'cheap-to-buy', 'motorsport', 'most-popular', 'all-stocks', 'rory', 'ross-gerber', 'most-bought', 'biggest-companies', 'investing-starterpack', 'ken-griffin'])
    ],
    [
        ...
        'about' => "",
        'sector' => "",
        'categories' => json_encode(['featured', 'best-performing-2024'])
    ],
    [
        ...
        'categories' => json_encode(['featured', 'entertainment', 'all-stocks', 'ross-gerber', 'emmet-savage'])
    ],
    [
        ...
        'categories' => json_encode(['featured'])
    ],
    [
        ...
        'categories' => json_encode(['featured', 'bitcoin-etfs'])
    ],
    [
        ...
        'categories' => json_encode(['featured', 'technology', 'cheap-to-buy', 'moneystart', 'investing-starterpack', 'all-stocks', 'ai-2025', 'magnificient-7', 'biggest-companies', 'ken-griffin', 'bill-gate'])
    ],
    [
        ...
        'categories' => json_encode(['featured', 'technology', 'cheap-to-buy', 'moneystart', 'motorsport', 'investing-starterpack', 'all-stocks', 'ai-2025', 'magnificient-7', 'most-popular', 'ken-griffin', 'bill-gate', 'ross-gerber'])
    ],
    [
        'name' => 'Netflix, Inc.',
        'trade_name' => 'NFLX',
        ...
        'categories' => json_encode(['featured', 'technology', 'entertainment', 'all-stocks', 'emmet-savage', 'most-popular', 'ken-griffin'])
    ],
    [
        ...
        'categories' => json_encode(['featured', 'energy-stocks'])
    ],
];